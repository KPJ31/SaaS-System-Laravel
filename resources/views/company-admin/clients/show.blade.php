...
@section('content')
@include('partials.page-header', ['eyebrow' => 'Client Details', 'title' => $client->name, 'description' => $client->company_name, 'actions' => new \Illuminate\Support\HtmlString('<a class="btn btn-primary" href="'.route('company-admin.clients.edit', $client).'"><i class="fa-solid fa-pen"></i>Edit</a>')])
