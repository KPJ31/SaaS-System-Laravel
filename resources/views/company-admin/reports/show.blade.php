...
@include('partials.page-header', [
    ...
    'actions' => new Illuminate\Support\HtmlString(
        '<a class="btn btn-outline-primary" href="'.route('company-admin.reports.export', $report).'"><i class="fa-solid fa-file-csv"></i>Download CSV</a>'.
        '<a class="btn btn-primary" href="'.route('company-admin.reports.pdf', $report).'"><i class="fa-solid fa-file-pdf"></i>Download PDF</a>'
    ),
])
