        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end notification-menu">
                <div class="dropdown-header d-flex justify-content-between align-items-center">
                    ...
                    @if(auth()->user()->unreadNotifications()->count())
                        <form method="POST" action="{{ route('super-admin.notifications.read-all') }}">
                            @csrf
                ...
                @forelse(auth()->user()->notifications()->latest()->take(5)->get() as $notification)
                    <a class="dropdown-item notification-item {{ $notification->read_at ? '' : 'is-unread' }}" href="{{ route('super-admin.notifications.index') }}">
                ...
                <a class="dropdown-item text-center" href="{{ route('super-admin.notifications.index') }}">View all notifications</a>
            </div>
        </div>
        <div class="dropdown">
