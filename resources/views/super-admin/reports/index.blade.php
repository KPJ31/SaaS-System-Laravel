                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="btn btn-sm btn-outline-primary" href="{{ route('super-admin.reports.show', $key) }}">
                                    <i class="fa-regular fa-eye" aria-hidden="true"></i> View
                                </a>
                                <a class="btn btn-sm btn-outline-primary" href="{{ route('super-admin.reports.export', $key) }}">
                                    <i class="fa-solid fa-file-csv" aria-hidden="true"></i> CSV
                                </a>
                                <a class="btn btn-sm btn-primary" href="{{ route('super-admin.reports.pdf', $key) }}">
